...
let cartUserSmall = cartUser.filter(function (item) {
    return item.price < 10000
});

let sumLength = cartUserSmall.length * 1000;

let sumCartUser = 0;
cartUser.forEach(function (item) {
    sumCartUser += item.price;
});

console.log('sum price:  ', sumLength + sumCartUser);
